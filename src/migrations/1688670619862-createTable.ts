...
export class CreateTable1688670619862 implements MigrationInterface {
    name = 'CreateTable1688670619862'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(80) NOT NULL, "cpf" character varying(11) NOT NULL, "phone" character varying(11) NOT NULL, "birthdate" date NOT NULL, "description" character varying(350), "typeUser" character varying(50) NOT NULL, "password" character varying(120) NOT NULL, "resetToken" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "announcements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(50) NOT NULL, "model" character varying(10) NOT NULL, "year" date NOT NULL, "fuel" character varying(50) NOT NULL, "km" integer NOT NULL, "color" character varying(30) NOT NULL, "fipePrice" integer NOT NULL, "price" integer NOT NULL, "description" text NOT NULL, "image" text NOT NULL, "userId" uuid, CONSTRAINT "PK_b3ad760876ff2e19d58e05dc8b0" PRIMARY KEY ("id"))`);
